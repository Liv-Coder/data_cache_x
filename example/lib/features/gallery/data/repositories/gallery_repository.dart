...
class GalleryRepository {
  ...
  GalleryRepository({DataCacheX? cache}) : _cache = cache ?? GetIt.I<DataCacheX>();
      ...
      for (int i = 0; i < count; i++) {
        ...
        images.add(
          GalleryImage(
            ...
            description: 'This is a sample image for testing the gallery feature',
            uploadDate: DateTime.now().subtract(Duration(days: random.nextInt(30))),
